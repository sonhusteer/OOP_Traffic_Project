...
public class CrossroadsMap implements MapConfig {
    ...
    public CrossroadsMap() {
        // ── Đèn giao thông (đặt gần vạch dừng theo hướng đi) ─────────────
        TrafficLight lightH1 = new CountdownLight(10, 13, 305, 395);      // road1 →
        TrafficLight lightH2 = new NoCountdownLight(10, 13, 495, 205);    // road2 ←
        lightH1.setInitialState(TrafficLight.State.GREEN, 10);
        lightH2.setInitialState(TrafficLight.State.GREEN, 10);

        TrafficLight lightV1 = new SmartTrafficLight(10, 13, 305, 205);   // road3 ↓
        TrafficLight lightV2 = new Last10SecondsLight(10, 13, 495, 395);  // road4 ↑
        ...
        road1.addWaypoint(320, 340); // vạch dừng
        lanes.add(road1);

        Lane road2 = new Lane(750, 260, 50, 260, lightH2);
        road2.addWaypoint(480, 260); // vạch dừng
        lanes.add(road2);

        Lane road3 = new Lane(360, 50, 360, 550, lightV1);
        road3.addWaypoint(360, 220); // vạch dừng
        lanes.add(road3);
