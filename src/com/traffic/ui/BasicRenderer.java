...
public class BasicRenderer extends JPanel implements IRenderer {
    ...
    /**
     * Tính vị trí hiển thị đèn tại GÓC NGÃ TƯ.
     * Trung tâm ngã tư ≈ (400, 300).
     * Dựa vào stop-line position của đèn để xác định góc nào:
     *   - Đèn làn ngang đi phải  (stop ~370, 280): góc trên-trái  → vẽ bên trái đường, phía trên
     *   - Đèn làn ngang đi trái  (stop ~430, 320): góc dưới-phải → vẽ bên phải đường, phía dưới
     *   - Đèn làn dọc đi xuống   (stop ~380, 270): góc trên-phải → vẽ phía trên, bên phải
     *   - Đèn làn dọc đi lên     (stop ~420, 330): góc dưới-trái → vẽ phía dưới, bên trái
     */
