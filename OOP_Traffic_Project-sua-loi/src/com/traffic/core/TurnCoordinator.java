...
public class TurnCoordinator {
    ...
    private void prepareVehicleForTightTurnSlot(Vehicle vehicle,
        ...
        if (hardWait) {
            ...
            if (lane != null) {
                ...
                LaneControlPoint cp = lane.getNextControlPoint(vehicle.getFrontProgress() - 30.0);
                if (cp != null) {
    ...
    private double handleInFor(Vehicle vehicle,
        ...
        double min = decision == Vehicle.TurnDecision.STRAIGHT ? 14.0 : (decision == Vehicle.TurnDecision.RIGHT ? 6.0 : 24.0);
    ...
    private double handleOutFor(Vehicle vehicle,
        ...
        double min = decision == Vehicle.TurnDecision.STRAIGHT ? 14.0 : (decision == Vehicle.TurnDecision.RIGHT ? 8.0 : 28.0);
        double max = switch (decision) {
            case RIGHT -> 18.0;
            case LEFT -> 74.0;
            case STRAIGHT -> 34.0;
