...
public class CrossroadsMap implements MapConfig {
    ...
    public CrossroadsMap() {
        ...
        // Explicit routing avoids angle-guessing chaos at busy intersections.
        // LEFT/RIGHT are defined relative to the vehicle heading.
        road1.setTurnTarget(ngaTu, Vehicle.TurnDecision.STRAIGHT, road1);
        road1.setTurnTarget(ngaTu, Vehicle.TurnDecision.LEFT, road4);
        road1.setTurnTarget(ngaTu, Vehicle.TurnDecision.RIGHT, road3);

        road2.setTurnTarget(ngaTu, Vehicle.TurnDecision.STRAIGHT, road2);
        road2.setTurnTarget(ngaTu, Vehicle.TurnDecision.LEFT, road3);
        road2.setTurnTarget(ngaTu, Vehicle.TurnDecision.RIGHT, road4);

        road3.setTurnTarget(ngaTu, Vehicle.TurnDecision.STRAIGHT, road3);
        road3.setTurnTarget(ngaTu, Vehicle.TurnDecision.LEFT, road1);
        road3.setTurnTarget(ngaTu, Vehicle.TurnDecision.RIGHT, road2);

        road4.setTurnTarget(ngaTu, Vehicle.TurnDecision.STRAIGHT, road4);
        road4.setTurnTarget(ngaTu, Vehicle.TurnDecision.LEFT, road2);
        road4.setTurnTarget(ngaTu, Vehicle.TurnDecision.RIGHT, road1);
